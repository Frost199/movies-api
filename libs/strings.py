...
def refresh():
    """
    loads the file set in `strings` top-level folder using the
    default_locale variable and sets the value
    and key in cached_strings as a dictionary
    :return
    """
    global cached_strings
    with open(f"{os.getcwd()}/strings/{default_locale}.json") as f:
